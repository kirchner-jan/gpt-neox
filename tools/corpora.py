...
class DataDownloader(ABC):
    ...
    def __init__(self, tokenizer_type=None, merge_file=None, vocab_file=None, data_dir=None, num_workers=None, conditional_finetune=None):
        ...
        self.conditional_finetune = conditional_finetune
...
def prepare_dataset(
    ...
    if DownloaderClass is None:
        ...
        d = DownloaderClass(
            ...
            conditional_finetune=conditional_finetune,
            )
